...
[CLI builds are published on GitHub](https://github.com/oicana/oicana/releases/tag/oicana_cli-v0.4.0). You can pick and install the correct binary yourself or let a script do it for you.
