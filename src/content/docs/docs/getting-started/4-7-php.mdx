...
3. Before proceeding, make sure your template is packaged. Navigate to your template directory and run:
   ...
   <Aside>
   The `oicana pack` command will create `example-0.1.0.zip` in the template directory. The command produces no output on success - you'll only see the .zip file appear.
   </Aside>
