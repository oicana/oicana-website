...
<CardGrid>
  <LinkCard title="Browser / React" href="/docs/getting-started/4-1-browser/" description="Prerequisites: Node.js 20.19+" />
  <LinkCard title="C# / ASP.NET" href="/docs/getting-started/4-2-csharp/" description="Prerequisites: .NET; preferably version 10" />
  <LinkCard title="Java / Spring Boot" href="/docs/getting-started/4-3-java/" description="Prerequisites: Java 17+ and Gradle" />
  <LinkCard title="Node.js / NestJS" href="/docs/getting-started/4-4-nodejs/" description="Prerequisites: Node.js 20.19+" />
