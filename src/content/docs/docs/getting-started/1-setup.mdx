...
<Aside type="tip" title="No license needed to follow this guide">
...
Install a [prebuild binary from GitHub](https://github.com/oicana/oicana/releases/tag/oicana_cli-v0.8.0-rc.1) or let a script do that for you.
