...
- **Vite**: add [`vite-plugin-compression2`](https://www.npmjs.com/package/vite-plugin-compression2) and list both algorithms.
...
Compression plugins ship a default file filter built for text assets, and `.wasm` is not in it. E.g. for vite:
