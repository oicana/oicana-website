...
Oicana takes a different route. Templates use the open source Typesetter [Typst](https://typst.app/). Your application passes typed inputs into the template, and Oicana compiles a PDF in a couple milliseconds.
...
Here's a minimal Oicana template — a Typst file with a manifest defining one JSON input:
...
<Aside>
For more information on Typst, please [take a look at their website](https://typst.app/).
</Aside>
