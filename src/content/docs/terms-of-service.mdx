...
description: Terms of Service for the Oicana software and commercial licenses.
---
...
You may use Oicana for commercial evaluation — including following the getting-started guide, building proof-of-concept integrations, and testing it internally — for up to 30 days from your first commercial use, without a paid subscription. Documents generated during evaluation must not be distributed externally or used in production. Continued use, or any production use, after the 30-day period requires a commercial subscription under Section 4.3.
...
(a) we publicly announce that we are discontinuing the Software;
...
(c) we become insolvent, enter into surseance van betaling or faillissement under the Dutch Bankruptcy Act (Faillissementswet), cease operations, or become legally incapacitated, in each case without a successor or assignee continuing to provide the Software under Section 16.3,
