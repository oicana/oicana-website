...
- **Through Paddle**: follow the subscription-management or refund link in your Paddle purchase-confirmation email.
- **By email**: contact us at [hello@oicana.com](mailto:hello@oicana.com) with the order reference from your Paddle receipt, and we will arrange the refund with Paddle.

All refunds are processed by Paddle and returned to the original payment method.
...
This means Paddle is responsible for the actual payment and refund transaction. You can also contact Paddle directly at any time using the links in your purchase-confirmation email. For details, see [Paddle's Checkout Buyer Terms](https://www.paddle.com/legal/checkout-buyer-terms).
...
Once a refund is approved, Paddle will initiate the refund within a few business days. Depending on your bank or card issuer, the funds may take several additional business days to appear on your statement.
...
- **Tax adjustments** — Paddle returns any VAT or sales tax collected on the original transaction; local tax rules may affect the exact amount.
- **Intermediary fees** — in rare cases your bank or card issuer may apply a fee to the refund transaction.

These variations are determined by payment networks and tax authorities, not by Oicana or Paddle.
...
For payment and billing inquiries that require direct contact with Paddle, please use the link provided in your purchase-confirmation email.
